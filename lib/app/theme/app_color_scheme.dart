...
class AppColorScheme {
  ...
  final Color colorIconInactive = const Color(0xff8e9190);
  ...
  final Color colorextendedstatuserrortext = const Color(0xffBB1713);
  ...
  final Color colorExtendedStatusWarning01 = const Color(0xffD46B08);
  ...
  final Color colorExtendedLabelErrorText = const Color(0xffde3730);
  ...
  final Color colorExtendedStatusSuccess01 = const Color(0xff08A32B);
  ...
  final Color colorRefPrimaryPrimary50 = const Color(0xff367ABF);
  final Color colorRefPrimaryPrimary80 = const Color(0xffA0C9FF);
  final Color colorRefPrimaryPrimary95 = const Color(0xffEAF1FF);
  final Color colorOutline02 = const Color(0xffB2AAA2);
  final Color colorOutline03 = Color(0xffEFEFF0);
  final Color colorRefNeutral125 = const Color(0xff3A3B3E);
  final Color colorRefNeutral135 = const Color(0xff515255);
  final Color colorRefNeutral170 = const Color(0xffABABAE);
  final Color colorRefNeutral150 = const Color(0xff76777A);
  final Color colorRefNeutral195 = const Color(0xffF1F0F4);

  final Color colorLabelTabBarSelected = const Color(0xff3A3B3E);
  final Color colorLabelTabBarUnSelected = const Color(0xff909094);
  final Color colorLabelMap = const Color(0xff0064BB);

  final Color colorExtendedBottomBar = const Color(0xff0F4C81);
  ...
  Color get colorExtendedTextTitleSmall =>
      _AppColorSchemeLight.colorextendedtexttitlesmalllight;
  Color get colorExtendedTextBodyLarge =>
      _AppColorSchemeLight.colorextendedtextbodyBodylargeLight;
  Color get colorExtendedTextBodyMedium =>
      _AppColorSchemeLight.colorextendedtextbodyBodymediumLight;
